...
Join us in a revolution that values truth and transparency. Together, we can build a network of informed citizens who are unafraid to speak out.`,
  ...
  const NOSTR_UI = {
    ...
    de: {
      ...
      safety_link: "Sicherheit & Privatsphäre",
    ...
    es: {
      ...
      safety_link: "Seguridad y privacidad",
    ...
    fa: {
      ...
      safety_link: "ایمنی و حریم خصوصی",
    ...
    fr: {
      ...
      safety_link: "Sécurité et confidentialité",
    ...
    pt: {
      ...
      safety_link: "Segurança e privacidade",
    ...
    ru: {
      ...
      safety_link: "Безопасность и конфиденциальность",
    ...
    sw: {
      ...
      safety_link: "Usalama na faragha",
    ...
    tr: {
      ...
      safety_link: "Güvenlik ve gizlilik",
