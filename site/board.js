(function () {
  ...
  function actionsCell(r) {
    ...
    if (isMine) {
      ...
      items = `<button type="button" class="board-menu-item" role="menuitem" data-act="block" data-pubkey="${escapeHtml(r.pubkey)}">${escapeHtml(t("act_block"))}</button>`;
    }
  ...
  async function init() {
    ...
    document.addEventListener("keydown", (e) => { if (e.key === "Escape") { closeDeleteModal(); closeRowMenus(null); } });
