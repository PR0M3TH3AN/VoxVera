...
Features:
- **--- إنشاء موقع/منشور جديد ---**: Start the full setup sequence.
- **--- تشغيل جميع المواقع ---**: Launch or shut down every flyer in your fleet at once.
- **Real-time Status**: View active `.onion` URLs and Tor bootstrapping progress indicators.
- **Individual Control**: تصدير إلى Zip specific sites to ZIP or delete them.
...
When you host a flyer, the **"تحميل الأداة والكود"** button on the landing page provides a `voxvera-portable.zip` containing:
