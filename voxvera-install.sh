...
msg "   Run 'voxvera autostart status' to inspect the recovery timer."
msg "   Run 'voxvera autostart uninstall' to remove the recovery timer."
msg "   Run 'bash scripts/linux-recovery-check.sh' from the repo for the Linux validation checklist."
msg "------------------------------------------------------------------"
